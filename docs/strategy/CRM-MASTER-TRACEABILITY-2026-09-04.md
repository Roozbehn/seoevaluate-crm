...
| CRM-AUDIT | AZCRM-AP-004 | Appointment detail linked from care tab | WS8 | — | CRM-M043 | live | VERIFIED |
...
| CRM-AUDIT | AZCRM-A11Y-003 | :focus-visible ring | WS14 | — | CRM-M015 | probe | VERIFIED |
| CRM-AUDIT | AZCRM-A11Y-004 | RTL logical properties; dir from language | WS14 | — | CRM-M064 + CRM-M020 | rtl smoke | VERIFIED |
...
| UIUX-OPT | A.1-10 | Ten highest-impact changes | WS2-WS8 | — | M032,M003,M023,M017,M024,M025,M035,M018,M021,M015 | each mapped | VERIFIED |
| UIUX-OPT | B | Target IA: 4 operational items + Yönetim; hide/move table | WS3 | — | CRM-M021 | live sidebar per role | VERIFIED |
| UIUX-OPT | C | Navigation: desktop sidebar groups, tablet off-canvas + icons behind chevron, phone tab bar, no breadcrumbs, back links, renames | WS3 | M015 | CRM-M021 + CRM-M022 | live at 3 widths | VERIFIED |
...
| UIUX-OPT | F | Patient workspace spec: header, stage bar, next panel, alerts, 9 tabs, timeline rules, phone | WS6 | M016,M017 | CRM-M025/M026/M027 | live | VERIFIED |
| UIUX-OPT | G | Mesajlar spec: three columns, list row, thread, context, tablet, phone strip+sheet, pause semantics | WS7 | M017 | CRM-M032–M037 | live | VERIFIED |
...
| UIUX-OPT | I | Quote spec: layout, statuses, deposit collapsed, role actions, Sales read-only | WS9 | — | CRM-M049 + CRM-M048 | live | VERIFIED |
| UIUX-OPT | J | Mobile matrix 390/768/1024 per screen; ≥44 px; no horizontal table scroll | WS14 | M015 | CRM-M071 assertions | Playwright | VERIFIED |
| UIUX-OPT | K | Accessibility rules table (14) | WS14 | — | CRM-M015/M063/M020 | probe/axe | VERIFIED |
| UIUX-OPT | L | Terminology canon; retired words; CI grep | WS2 | — | CRM-M018 | grep gate | VERIFIED |
| UIUX-OPT | M | RTL strategy (9 rules) | WS14 | — | CRM-M064 | rtl smoke | VERIFIED |
| UIUX-OPT | N | Design system delivery via se-ds.css + helpers | WS2 | — | CRM-M015/M016 | file present, loaded | VERIFIED |
| UIUX-OPT | O | Mockups as target | WS16 | — | visual verification | CRM-UIUX-VISUAL-VERIFICATION | VERIFIED |
| UIUX-OPT | P | Before/after per screen | WS16 | — | productivity results | CRM-PRODUCTIVITY-RESULTS | VERIFIED |
| UIUX-OPT | Q | Component inventory → se-* classes + helpers | WS2 | — | CRM-M015/M016 | helpers exist | VERIFIED |
...
| DESIGN-SYSTEM | 1.1 | Colour tokens dark+light, semantic set incl. action; retire #71717a and inline palettes | WS2 | — | CRM-M015 | se-ds.css tokens; grep inline styles | VERIFIED |
| DESIGN-SYSTEM | 1.2 | Type scale 24/18/15/14/13, min 12, tabular nums | WS2 | — | CRM-M015 | css | VERIFIED |
| DESIGN-SYSTEM | 1.3 | Spacing tokens 4–32; card 16/24; page 24/16 | WS2 | — | CRM-M015 | css | VERIFIED |
| DESIGN-SYSTEM | 1.4 | Radius 8/12/pill/14; flat elevation; motion under reduced-motion | WS2 | — | CRM-M015 | css | VERIFIED |
| DESIGN-SYSTEM | 1.5 | Controls 40/44; sidebar 232; header 56 | WS2 | — | CRM-M015 | css | VERIFIED |
| DESIGN-SYSTEM | 2.1 | Buttons variants/states/one primary per group | WS2 | — | CRM-M015/M016 | helpers | VERIFIED |
...
| DESIGN-SYSTEM | 2.4 | Patient summary header | WS6 | — | CRM-M025 | live | VERIFIED |
| DESIGN-SYSTEM | 2.5 | Stage bar 7 segments | WS6 | — | CRM-M025 | live | VERIFIED |
...
| DESIGN-SYSTEM | 2.8 | Cards | WS2 | — | CRM-M015 | css | VERIFIED |
...
| DESIGN-SYSTEM | 2.12 | Tabs 44 px, scroll, tablist | WS6 | — | CRM-M027 | live | VERIFIED |
| DESIGN-SYSTEM | 2.13 | Timeline with Turkish labels | WS6 | — | CRM-M026 | live | VERIFIED |
| DESIGN-SYSTEM | 2.14 | Chat bubbles, auto tag, composer row rules | WS7 | — | CRM-M032/M037 | live | VERIFIED |
| DESIGN-SYSTEM | 2.15 | Calendar type colours; agenda ≤767 | WS8 | — | CRM-M003/M040 | live | VERIFIED |
| DESIGN-SYSTEM | 2.16 | Mobile shell: tab bar, hide in thread, FAB | WS3/WS7 | — | CRM-M022/M032 | live | VERIFIED |
| DESIGN-SYSTEM | 2.17 | Empty states pattern | WS2 | — | CRM-M016 | helper | VERIFIED |
| DESIGN-SYSTEM | 2.18 | Modals/sheets | WS7 | — | CRM-M033 | live | VERIFIED |
| DESIGN-SYSTEM | 3 | Layout grid per breakpoint | WS14 | — | CRM-M015 | css | VERIFIED |
| DESIGN-SYSTEM | 4 | Bootstrap-3 notes: load after theme, scope .se-*, body.se-clinic overrides, helper API, icons aria, theme flip, RTL logical | WS2 | — | CRM-M015/M016/M064 | code | VERIFIED |
...
| UX-COPY | 3.3 | Quote statuses | WS9 | — | CRM-M049 | live | VERIFIED |
| UX-COPY | 3.4 | Appointment types/statuses | WS8 | — | CRM-M039 | live | VERIFIED |
| UX-COPY | 3.5 | Consent badges | WS6 | — | CRM-M025 | live | VERIFIED |
...
| UX-COPY | 10 | lang attribute per staff/patient | WS14 | — | CRM-M020 | live | VERIFIED |
| UIUX-BACKLOG | UX-F01 | Ship se-ds.css | WS2 | — | CRM-M015 | file + probe | VERIFIED |
...
| UIUX-BACKLOG | UX-NAV02 | Mobile bottom tab bar | WS3 | — | CRM-M022 | live 390 | VERIFIED |
| UIUX-BACKLOG | UX-NAV03 | Tablet header fix | WS14 | — | CRM-M015 | live 769 | VERIFIED |
| UIUX-BACKLOG | UX-NAV04 | Global search ⌘K | WS3 | M019 | CRM-M075 | PLANNED | VERIFIED |
...
| UIUX-BACKLOG | UX-Q03 | Sales role sees quote read-only | WS9 | — | CRM-M049 | test | VERIFIED |
| UIUX-BACKLOG | UX-X01 | Contrast + focus + sizes | WS14 | — | CRM-M015 | probe | VERIFIED |
| UIUX-BACKLOG | UX-X02 | Names and labels | WS14 | — | CRM-M063 | probe | VERIFIED |
