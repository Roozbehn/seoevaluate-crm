...
$r1 = se_cron_run_isolated(function () use (&$steps) { $steps[] = 'a'; throw new RuntimeException('token=EAAGm0PX4ZCpsBA1ZBxYZBqZC7ZBLongTokenValueHere boom'); });
$r2 = se_cron_run_isolated(function () use (&$steps) { $steps[] = 'b'; return 42; });
se_eq(['a', 'b'], $steps, 'the second step ran although the first threw');
