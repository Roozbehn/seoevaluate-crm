...
CFG=/home/hyundaic/crm.azinasgari.com/application/config/app-config.php
ORIGIN=57.129.84.98
...
curl -sS -m 55 -o /dev/null -w "%{http_code}\n" \
  --resolve "crm.azinasgari.com:443:$ORIGIN" \
  "https://crm.azinasgari.com/se_core/dispatch/index/$KEY"
