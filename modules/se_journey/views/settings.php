  ...
  <div class="col-md-7">
    ...
    <div class="panel_s"><div class="panel-body">
      ...
      <?php echo form_open(admin_url('se_journey/se_journey/save_settings')); ?>
        ...
        <div class="checkbox checkbox-primary"><input type="checkbox" id="cb_auto_ads" name="auto_ads" value="1" <?php echo !empty($v['auto_ads']) ? 'checked' : ''; ?> /><label for="cb_auto_ads"><?php echo html_escape(_l('se_journey_flag_auto_ads')); ?></label><br /><small class="text-muted"><?php echo html_escape(_l('se_journey_flag_auto_ads_hint')); ?></small></div>
        <div class="checkbox checkbox-primary"><input type="checkbox" id="cb_timers" name="timers" value="1" <?php echo !empty($v['timers']) ? 'checked' : ''; ?> /><label for="cb_timers"><?php echo html_escape(_l('se_journey_settings_timers')); ?></label><br /><small class="text-muted"><?php echo html_escape(_l('se_journey_settings_timers_hint')); ?></small></div>
        <div class="checkbox checkbox-primary"><input type="checkbox" id="cb_ads_from_intake" name="ads_from_intake" value="1" <?php echo !empty($v['ads_from_intake']) ? 'checked' : ''; ?> /><label for="cb_ads_from_intake"><?php echo html_escape(_l('se_journey_flag_ads_from_intake')); ?></label><br /><small class="text-muted"><?php echo html_escape(_l('se_journey_flag_ads_from_intake_hint')); ?></small></div>
        <div class="row">
    ...
    <div class="panel_s"><div class="panel-body">
      ...
      <?php echo form_open(admin_url('se_journey/se_journey/save_settings')); ?>
        ...
        <div class="form-group"><label><?php echo html_escape(_l('se_journey_aftercare_guide_url')); ?></label><input class="form-control" name="aftercare_guide_url" value="<?php echo html_escape($v['aftercare_guide_url']); ?>" placeholder="https://azinasgari.com/tr/aftercare" /></div>
