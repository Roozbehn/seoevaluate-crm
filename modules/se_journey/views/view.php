...
<div id="wrapper"><div class="content se-page se-patient">
  ...
  <div class="se-card">
    ...
    <div class="se-stack" style="margin-top:12px">
      ...
      <?php if ($quote_latest && $quote_latest->status === 'sent' && !empty($quote_latest->valid_until) && strtotime($quote_latest->valid_until . ' 23:59:59') < time() && (string) $j->state === 'quote_sent') { echo se_ui_alert('warning', _l('se_pw_quote_expired', [(int) $quote_latest->version, se_ui_when($quote_latest->valid_until . ' 00:00:00')]), $can['edit_review'] ? ['label' => _l('se_journey_new_version'), 'href' => $tabUrl('review')] : null); } ?>
